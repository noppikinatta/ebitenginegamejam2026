...
func testConfig() Config {
	return Config{
		...
		XPToNextGrowth:      1.25,
		Player:              Player{HP: 100, MaxHP: 100, Speed: 3, Radius: 16, Level: 1, XPToNext: 10},
		...
		EnemyScaling:        EnemyScaling{HPBase: 10, HPPerTick: 1.0 / 120.0, Speed: 1.2, Radius: 12, Damage: 8, XPValue: 3},
		Candlestick:         Enemy{HP: 40, Radius: 13, DropsNipper: true},
