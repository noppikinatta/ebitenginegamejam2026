...
var junkSpecs = []junkSpec{
	...
	{Name: "Fax Machine"},
	{Name: "Lava Lamp", Tall: true},
	{Name: "Oil Heater"},
	{Name: "Rice Cooker"},
	{Name: "Modern Art Fountain"},
	{Name: "Concept"},
	{Name: "NFT Nuclear Missile", Tall: true},
	{Name: "Horns"},
	{Name: "High-End GPU"},
	// Devices that emit something. Each is wired to a cosmetic emitter.
	{Name: "Balloon Service Unit", Tall: true, Emitter: &balloonEmitter},
	{Name: "Coffee Maker", Tall: true, Emitter: &coffeeEmitter},
	{Name: "Toaster", Tall: true, Emitter: &toasterEmitter},
	{Name: "Music Box", Tall: true, Emitter: &musicBoxEmitter},
	{Name: "Rubber Duck Dispenser", Tall: true, Emitter: &duckEmitter},
	{Name: "Fireworks", Tall: true, Emitter: &fireworksEmitter},
}
